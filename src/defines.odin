...
H_GRID_MARGIN        :: 100
V_GRID_MARGIN        :: (WINDOW_HEIGHT - (BOARD_SIDE * CELL_SIZE)) / 2
BUTTON_WIDTH         :: 300
BUTTON_HEIGHT        :: 50
BUTTON_GAP           :: 10
BUTTON_EXIT_TOP      :: V_GRID_MARGIN + (CELL_SIZE * (BOARD_SIDE - 1)) + (CELL_SIZE - BUTTON_HEIGHT)
BUTTON_NEW_GAME_TOP  :: BUTTON_EXIT_TOP - BUTTON_GAP - BUTTON_HEIGHT
BUTTON_LEFT          :: (H_GRID_MARGIN * 2) + (BOARD_SIDE * CELL_SIZE)
